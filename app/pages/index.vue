  ...
  >
    ...
    >
      ...
      <img
        ...
        class="hidden lg:block 2xl:hidden rounded-lg left-0 w-full max-w-2xl"
      >
      <img
        :src="page.section.images.mobile"
        :alt="page.section.title"
        class="block lg:hidden 2xl:block rounded-lg 2xl:w-full 2xl:max-w-2xl"
      >
    </UPageSection>
...
<!--     <UPageSection
      ...
      :features="page.model.model"
      orientation="horizontal"
      :ui="{ container: 'lg:px-0 2xl:px-20 mx-0 max-w-none md:mr-10', features: 'gap-0' }"
      reverse
    >
      <template #title>
        <MDC :value="page.model.title" class="sm:*:leading-11" />
      </template>

      <img
        v-if="page.model.images?.desktop"
        :src="page.model.images.desktop"
        :alt="page.model.title"
        class="hidden lg:block 2xl:hidden left-0 w-full max-w-2xl"
      />
      <img
        v-if="page.model.images?.mobile"
        :src="page.model.images.mobile"
        :alt="page.model.title"
